  ...
  return (
    <section className="max-w-7xl mx-auto">
      <div className='justify-center text-left py-20'>
        {/* TITLE AND SUB TITLE */}
        <h1 className="font-extrabold font-nunito text-darkblue text-[50px]">CATALYST CHALLENGES</h1>
        ...
        <div className='flex flex-col md:flex-row'>
          {/* -----------Filter items----------- */}
          {/* checkboxes type */}
          <div className='w-[300px] mb-10 hidden'>
            <h2>Filters</h2>
          ...
          <div className='md:ml-5'>
            <div className='grid lg:grid-cols-3 hub:grid-cols-2 md:grid-cols-2 grid-cols-1 gap-4 hub:gap-5'>
              <ChallengeCard />
              <ChallengeCard />
              <ChallengeCard />
              <ChallengeCard />
