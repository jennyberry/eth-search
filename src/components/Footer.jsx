...
const Footer = () => {
    return (
        <section className='w-full justify-between items-center py-5 '>
            <div className='flex flex-col mx-auto text-left'>
                <div className='flex flex-row justify-evenly  '>
                    ...
                    <div>
                        <h2 className='text-blue'>Resource</h2>
                        <ul className='text-left'>
                            <li>Cardano.org</li>
                            <li>Cardano Foundation</li>
                            <li>Essential Cardano</li>
                            <li>IOHK</li>
                        </ul>
                    </div>
                ...
                <div className='flex flex-row justify-evenly pt-5'>
                    <p className='text-gray'>©2020 C3ETH. All rights reserved.</p>
                    <div>
